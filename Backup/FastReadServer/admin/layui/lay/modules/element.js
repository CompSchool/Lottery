      ...
      , f = {
        ...
        tabAuto: function() {
            ...
            a(".layui-tab").each(function() {
                ...
                if (n === window && 8 != t.ie && f.hideTabMore(!0),
        ...
        hideTabMore: function(i) {
            ...
            i !== !0 && "tabmore" === a(i.target).attr("lay-stope") || (t.removeClass("layui-tab-more"),
        ...
        clickThis: function() {
            var i = a(this)
              , t = i.parents(o)
              , n = t.attr("lay-filter");
            i.find("." + d)[0] || (t.find("." + e).removeClass(e),
            i.addClass(e),
        ...
        showChild: function() {
            var i = a(this)
              ...
              , l = i.parent()
              , e = i.siblings("." + d);
            t.hasClass(u) && (e.removeClass(y),
            l["none" === e.css("display") ? "addClass" : "removeClass"](c + "ed"))
        },
        collapse: function() {
            var i = a(this)
            ...
            nav: function() {
                var i, l, e, s = 200, p = function(o, c) {
                    ...
                    o.css({
                        ...
                        top: r.position().top + r.height() + 12
                    }),
                    ...
                    clearTimeout(e),
                    "block" === f.css("display") && clearTimeout(l),
                ...
                a(o).each(function() {
                    var t = a(this)
                      ...
                      , y = t.find("." + c);
                    t.find("." + r)[0] || (t.append(o),
                    y.on("mouseenter", function() {
                        p.call(this, o, t)
                    }).on("mouseleave", function() {
                        t.hasClass(u) || (clearTimeout(l),
                        l = setTimeout(function() {
