...
<asp:Content ID="Content1" ContentPlaceHolderID="rightContent" runat="server">
    <div class="breadcrumbs" id="breadcrumbs">
        ...
        <ul class="breadcrumb">
            <li><i class="menu-icon fa fa-folder-open"></i><a href="#">用户信息</a> </li>
    ...
    <script>
        ...
        function DoSearch(pg) {
            curPage = pg;
            //新闻
            window._IF.GetAwardUsers(this,
            {
                "vercode": $("#txtSearchName").val(),//新闻
                "page": pg, "all": 1,
                "limit": 12
            },
            fnAwardUsersListCallBack,
            function () {
            });
        ...
        function fnAwardUsersListCallBack(r) {
            if (r.ok) {
                //删除原有的记录
                $("#databody").html("");
                ...
                for (var i = 0; i < r.lst.length; i++) {
                    ...
                    sHtml += "<td>";
                    if (row.state == "1") {
                        sHtml += "<a class=\"ace-icon fa fa-no bigger-120 red\" href=\"javascript:DoStop(" + row.UserID + ")\">停用</a>";
                    } else {
                        sHtml += "<a class=\"ace-icon fa fa-check bigger-120 green\" href=\"javascript:DoPass(" + row.UserID + ")\">启用</a>";
                    }

                    sHtml += "<a class=\"ace-icon fa fa-flag bigger-120 blue\" href=\"javascript:ShowReply(" + row.UserID + ")\">修改备注</a>";
